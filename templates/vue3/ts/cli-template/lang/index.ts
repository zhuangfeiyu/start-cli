...
export function setLocale(locale: string) {
    // 设置 dayjs locale
    const dayjsLocale = dayjsLocaleMap[locale as keyof typeof dayjsLocaleMap] || dayjsLocaleMap[LangEnum.zhCN];
    dayjs.locale(dayjsLocale);
    // 设置 Element Plus locale
    elementPlusLocale.value = elementPlusLocaleMap[locale as keyof typeof elementPlusLocaleMap] || elementPlusLocaleMap[LangEnum.zhCN];
    // 设置 i18n locale
